...
public class Examen extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_examen, container, false);
        ...
        if (!edtDia.getText().toString().equals("") ) {
            try {
                ...
                String insert = "insert into " + Utilidades.TABLA_EVENTOS +
                        ...
                        ") values ('" + edtTitulo.getText().toString() + "' ,'" + edtDescripcion.getText().toString() + "', '" + edtDia.getText().toString() + "', '" + edtHora.getText().toString() + "', '" + edtLocalizacion.getText().toString() + "' ,'" + "Tarea" + "' )";
                db.execSQL(insert);
