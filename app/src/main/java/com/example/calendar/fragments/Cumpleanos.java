 ...
 * Use the {@link Cumpleanos#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Cumpleanos extends Fragment {
    ...
    private EditText edtTitulo, edtDescripcion, edtDia, edtLocalizacion;
     ...
     * @return A new instance of fragment Cumpleanos.
     */
    // TODO: Rename and change types and number of parameters
    public static Cumpleanos newInstance(String param1, String param2) {
        Cumpleanos fragment = new Cumpleanos();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View vista= inflater.inflate(R.layout.fragment_cumpleanos, container, false);
        ...
        if (!edtDia.getText().toString().equals("") ) {
            ...
            try {
                ...
                String insert = "insert into " + Utilidades.TABLA_EVENTOS +
                        " ( " + Utilidades.CAMPO_TITULO + "," + Utilidades.CAMPO_DESCRIPCION + "," + Utilidades.CAMPO_FECHA + "," + Utilidades.CAMPO_LOCALIZACION + "," + Utilidades.CAMPO_TIPO +
                        ") values ('" + edtTitulo.getText().toString() + "' ,'" + edtDescripcion.getText().toString() + "', '" + edtDia.getText().toString() + "', '" + edtLocalizacion.getText().toString() + "' ,'" + "Cumpleaños" + "' )";
                db.execSQL(insert);
