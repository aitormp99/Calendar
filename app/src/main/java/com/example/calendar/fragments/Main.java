...
import com.example.calendar.EventReciclerAdapter;
...
public class Main extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        noEventos = vista.findViewById(R.id.eventosHoy);
        recyclerViewEvent = vista.findViewById(R.id.recyclerEvents);
    ...
    private void consultarListaEventos() {
        ...
        Event event = null;
        Cursor cursor = db.rawQuery("select * from "+ Utilidades.TABLA_EVENTOS +" where "+Utilidades.CAMPO_FECHA+"="+ "'"+strDate+"'" ,null);
